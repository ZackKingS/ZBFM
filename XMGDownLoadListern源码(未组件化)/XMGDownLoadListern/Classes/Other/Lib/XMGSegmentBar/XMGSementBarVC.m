...
@interface XMGSementBarVC ()<XMGSegmentBarDelegate, UIScrollViewDelegate>
...
@implementation XMGSementBarVC
- (XMGSegmentBar *)segmentBar {
    if (!_segmentBar) {
        XMGSegmentBar *segmentBar = [XMGSegmentBar segmentBarWithFrame:CGRectZero];
...
#pragma mark - 选项卡代理方法
- (void)segmentBar:(XMGSegmentBar *)segmentBar didSelectIndex:(NSInteger)toIndex fromIndex:(NSInteger)fromIndex
{
